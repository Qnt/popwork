        ...
        <section className="flex flex-col items-center justify-center bg-hero-pattern bg-cover bg-[50%_100%] bg-no-repeat">
          ...
          <div className="relative mb-[120px] mt-16 h-[180px] w-[600px] rounded-r-xl rounded-bl-[4px] rounded-tl-xl bg-[#FEFCFA] p-6 pr-14 shadow-[0px_4px_16px_0px_#F4E6D7]">
            <div className="flex flex-col gap-[22px] text-lg leading-[22px]">
              <p>
                Every week, Popwork asks a few simple questions to your team
                about what matters. It’s what we call a check-in. ✌️
              </p>
              <p>
                Popwork is also an intuitive workspace to prepare 1-to-1
                meetings, share feedback and follow up on topics week after
                week.
              </p>
            </div>
            <Image
          ...
          <div className="flex flex-col items-center gap-[44px] px-40 pb-20 pt-10">
            ...
            <div className="flex gap-12 text-base font-normal">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p>Senior managers</p>
                <p className="mt-[18px]">
                  Gain time and boost your team’s performance and engagement
                  week after week
                </p>
              </div>
              <div className="flex flex-col items-center text-center">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <p>Remote managers</p>
                <p className="mt-[18px]">
                  Maintain close contact with your team remotely while
                  developing autonomy
                </p>
              </div>
            </div>
        ...
        <section className="relative">
          <div className="mx-auto w-[1000px] text-pretty">
            ...
            <div className="mt-10 text-[26px] leading-9">
              ...
              <p className="mt-[39px]">
                Management is the very foundation of every organisation,
                impacting the way we perform and find purpose at work.
              </p>
              <p className="mt-[29px]">
                Yet for too long,{" "}
                <span className="bg-accent2">
              ...
              <p className="mt-[40px]">
                <span className="bg-accent1">
                  Choosing Popwork is choosing to improve the way your team
                  works.
                </span>
              </p>
            </div>
              ...
              <div className="relative pt-16">
                <div className="w-[400px] max-w-80 rounded-r-2xl rounded-bl-[4px] rounded-tl-2xl bg-primary px-4 pb-[15px] pt-[17px] font-normal leading-[22px] tracking-normal text-white shadow-message">
                  <p>
                    ...
                    theories, only best practices and actionable tips based on
                    the experience of hundreds of managers.
                  </p>
